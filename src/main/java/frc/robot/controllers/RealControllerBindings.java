...
public class RealControllerBindings implements ControllerBindings{
    ...
    @Override
    public double getDriveXValue() {return -leftFlightStick.getY();}

    @Override
    public double getDriveYValue() {return -leftFlightStick.getX();}

    @Override
    public double getDriveTurnValue() {return -rightFlightStick.getRawAxis(0);}
